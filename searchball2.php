...
while ($row = mysql_fetch_assoc($result))
{
	...
	//. "<td><a href='?searchterm={$row['day']}&searchtype=day'>{$row['day']}</a></td>"
        ...
        {
           $contentmyself_matches .= "<td><a href='?searchterm={$row['day']}&searchtype=day'><font color=red>{$row['day']}</font></a></td>";
        }
        else
        {
          $contentmyself_matches .= "<td><a href='?searchterm={$row['day']}&searchtype=day'>{$row['day']}</a></td>";
        }
	
	$contentmyself_matches .= "<td>{$row['time']}</td>"
	. "<td><a href='?searchterm={$row['typename']}&searchtype=typename&pageball={$pageball}&typename={$row['typename']}&table=myself_matchtype'>{$row['typename']}</a></td>"
	. "<td><a href='?searchterm={$row['hometeam']}&searchtype=all&limit=hometeam,guestteam&pageball={$pageball}&teamname={$row['hometeam']}&table=myself_teams'>{$row['hometeam']}</a></td>"
	. "<td>{$row['points']}</td>"
	//. "<td><a href='?searchterm={$row['guestteam']}&searchtype=all&limit=hometeam,guestteam&pageball={$pageball}&teamname={$row['guestteam']}&table=myself_teams'>{$row['guestteam']}</a></td>"
	. "<td><a href='?searchterm={$row['guestteam']}&searchtype=all&limit=hometeam,guestteam&pageball={$pageball}&teamname={$row['guestteam']}&table=myself_teams'>{$row['guestteam']}</a></td>"
	. "<td>{$row['halfpoints']}</td>"
