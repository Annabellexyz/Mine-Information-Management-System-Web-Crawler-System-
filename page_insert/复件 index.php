...
<form name="form1" method="post" action="index_insert.php">
  <tr>
    <td height="40" colspan="3" align="center"><span class="STYLE1"><strong>160电信黄页单条数据录入</strong></span></td>
  </tr>
  <tr>
    <td width="40" height="25" align="center" class="STYLE2">编辑:</td>
    <td><input name="editor" type="text" id="editor" value="<?php echo $_username; ?>" readonly size="64"></td>
    
    <td width="100"  class="STYLE2">登录后显示</td>
  </tr>
  <tr>
