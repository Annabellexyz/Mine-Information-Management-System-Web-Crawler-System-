...
$sqlstr = "INSERT INTO china_szpage ( 
            envelopeid,remark, fullname, amount,
           district,road,number,edifice,floor,linkman,business,
           new_phone,mobilephone,fax,website,email,qqmsn,principal,editor,edittime) 
           VALUES (
           '$envelopeid','$remark', '$fullname','$amount',
           '$district','$road','$number','$edifice',
           '$floor','$linkman','$business','$new_phone','$mobilephone','$fax','$website','$email','$qqmsn',
           '$principal','$editor','$edittime'
)";
echo "<br>";
echo $sqlstr;
...
if($query==true)
     {	     	
	     	...
	     	."<a href='/mine/page_insert'>点击此处继续插入数据</a>";
