...
// 分页字符串
$pageationmyself_busline = "共{$row['PageNum']}条数据 " . index_page($row['PageNum'], $linksize, $pagesize, 'pageball', array('searchterm', 'searchtype'));
...
// 表格头
	$contentmyself_busline .= 	"<h4 align='CENTER'>公交busline搜索结果</h4>"
