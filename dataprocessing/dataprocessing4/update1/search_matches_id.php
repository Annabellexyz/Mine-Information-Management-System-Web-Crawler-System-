 ...
 
{
  for($i=0;$i<count($keywords);$i++)           
   ...
   $query = "select * from myself_matches where tid like '%".$keywords[$i]."%' or teamname like '%".$keywords[$i]."%' or teamname_big like '%".$keywords[$i]."%' or ename like '%".$keywords[$i]."%' or tintro like '%".$keywords[$i]."%'"; 
    else         //多个关键词的情况                             
    $query = $query."UNION select * from myself_matches where tid like '%".$keywords[$i]."%' or teamname like '%".$keywords[$i]."%' or teamname_big like '%".$keywords[$i]."%' or ename like '%".$keywords[$i]."%' or tintro like '%".$keywords[$i]."%'"; 
   }
