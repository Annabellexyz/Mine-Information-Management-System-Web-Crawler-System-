	...
	if(document.getElementById("remark").value=="")
	...
	else
		{
			...
			if(document.getElementById("remark").value=="正确")
				{	
					//电话只能是8位数或者以上的数字，每个号码用分号隔开if(!document.getElementById("new_phone").value.match(/^(\d{8}(；)?)+$/))   /*   /^\d{8,}$/   */	
					//if(!document.getElementById("new_phone").value.match(/^\w{8,}$/)) 	
...
//"<form name=form1 method=post action='index_update.php?lmbs={$row[id]}'"
 $content_id .= "<table align='center' width='620' border='1'>"
             ...
             ."<form name='form1' method='post' onsubmit='return ck()' action='index_update.php?lmbs={$row[id]}'>"
              ...
              ."<td>{$row['detail']}</td></tr>"   
              ."<tr><td width=150 align='center' class='STYLE1'><font color=red>企业联系人</font></td>" 
...
$content .="<table height=264 border=0 cellpadding=0 cellspacing=0 >"
         ."<tr>"
	       ...
	       ."<td  align='center' class='STYLE1'>企业联系人</td>" 
