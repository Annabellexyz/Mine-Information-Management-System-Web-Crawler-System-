...
var ck=function()
{
	if(document.getElementById("remark").value=="")
	...
	else
		{
			...
			if(document.getElementById("remark").value=="正确")
				{	
					if(!document.getElementById("new_phone").value.match(/^(\d{8}(；)?)+$/))   /*   /^\d{8,}$/   */				
						{
							alert("电话位数不对！")
							return false
						}
...
/*if(document.getElementById("remark").value=="正确")
{	
if(!document.getElementById("new_phone").value.match(/^\d{0,7}$/))
{}
else
{
alert("电话位数不对！")
...
<body>
  ...
  <tr>
    ...
    <td width="120"><a href="/mine/page_update2/instruction.txt">使用说明</a></td>
  </tr>
</table>
<?php 
...
//"<form name=form1 method=post action='index_update.php?lmbs={$row[id]}'"
 $content_id .= "<table align='center' width='620' border='1'>"
             ...
             ."<form name='form1' method='post' onsubmit='return ck()' action='index_update.php?lmbs={$row[id]}'>"
              ...
              ."<tr><td width=150 align='center' class='STYLE1'>详细资料（不修改）</td>"
              ."<td>{$row['detail']}</td></tr>"   
              ."<tr><td width=150 align='center' class='STYLE1'>法人</td>" 
              ."<td><input name='person' type='text' id='person' value='{$row[person]}' size='30'></td></tr>"
              ."<tr><td width=150 align='center' class='STYLE1'>企业类型</td>" 
              ...
              ."<tr><td width=150 align='center' class='STYLE1'>新电话（*）</td>" //onBlur='(remak.value=="正确")?checkInput(this.form):return'
           //   ."<td><input name='new_phone' type='text' id='new_phone' value='{$row[new_phone]}' size='60' onBlur='checkInput(this.form);' ></td></tr>"
           //   ."<td><input name='new_phone' type='text' id='new_phone' value='{$row[new_phone]}' size='60' onBlur='javascript:(remak.value==\"正确\")?checkInput(this.form):void(0)' ></td></tr>"
           //暂时不要 ."<td><input name='new_phone' type='text' id='new_phone' value='{$row[new_phone]}' size='60' onBlur='javascript:(remark.value==\"正确\")?checkInput(this.form):void(0)' ></td></tr>"
...
$content ="";					
$content .="<table width=150 border=1 cellpadding=0 cellspacing=0>"
		     ."<tr>"
		     ."<td  align='center' class='STYLE1'>ID</td>"
		     //."<td width=150 align='center' class='STYLE1'>编码</td>"
	       ."<td  height=25 align='center' class='STYLE1'>发行备注</td>"//原来为大厦类型
	       ."<td  align='center' class='STYLE1'>信息编码</td>"
	       ."<td  align='center' class='STYLE1'>原发行名称</td>"//公司原完整名称
	       ."<td  align='center' class='STYLE1'>原电话</td>" 
	       ."<td  align='center' class='STYLE1'>新电话</td>" 
	       ."<td width=100 align='center' class='STYLE1' >详细资料</td>" 
	       ."<td  align='center' class='STYLE1'>法人</td>" 
	       ."<td  align='center' class='STYLE1'>企业类型</td>" 
	       ."<td  align='center' class='STYLE1'>原地址</td>"
	       ."<td  align='center' class='STYLE1'>大厦/工业区/花园</td>"
	       ."<td  align='center' class='STYLE1'>剩余地址</td>"//原为栋、层
	       ."<td  height=25 align='center' class='STYLE1'>主营</td>"
	       ."<td  height=25 align='center' class='STYLE1'>传真</td>" 
	       ."<td height=25 align='center' class='STYLE1'>网址</td>" 
...
while ($row = mysql_fetch_assoc($result))
{
    ...
    //  . "<td align='center' class='STYLE1'><input name='pid' type='text' id='pid' value='{$row[pid]}' readonly size='6'></td>"
      . "<td align='center' class='STYLE1' ><input name='remark' type='text' id='remark' value='{$row[remark]}' size='10'></td>"
      . "<td align='center' class='STYLE1'><input maxlength='5' name='info_code' type='text' id='info_code' value='{$row[info_code]}' readonly size='7'></td>"
      . "<td align='center' class='STYLE1'><input name='name' type='text' id='name' value='{$row[name]}' readonly size='20'></td>"
    . "<td align='center' class='STYLE1'><input name='telephone' type='text' id='telephone' value='{$row[telephone]}' readonly size='20'></td>"
    . "<td align='center' class='STYLE1'><input name='new_phone' type='text' id='new_phone' value='{$row[new_phone]}' size='20'></td>"
   ...
   //   . "<td align='center' class='STYLE1'><input name='principal' type='text' id='principal' value='{$row[principal]}' size='10'></td>"  
     ...
     // . "<td align='center'><input type='image' name='imageField' src='images/bg1.jpg'></td>"//暂时不让录入员在此处点击修改数据
      . " </tr>"
	    . "</form>";
}
}
