...
if ($__GET['id'])//点击关键词
{
 ...
 while ($row = mysql_fetch_assoc($result)){
 	...
 	$envelopeid = stripslashes($row['envelopeid']);
 ...
 $content_id .= "<table align='center' width='620' border='1'>"
           ...
           //   ."<tr><td width=120 align='center' class='STYLE1'>行业类别</td>"
            //  ."<td><input name='category' type='text' id='category' value='{$row[category]}' size='25'></td></tr>"
              ...
              ."<tr><td width=120 align='center' class='STYLE1'>录入日期</td>"
              ."<td><input name='edittime' type='text' id='edittime' value='{$row[edittime]}' readonly size='20'></td></tr>"
              . "<tr><td width=120 align='center' class='STYLE1'>提交</td><td align='left'><input type='image' name='imageField' src='images/bg1.jpg'></td></tr>"
              ."</form>"
              ."</table>" ;            
}
}
...
$query1 ="SELECT * FROM `china_szpage` {$sqlWhere} ORDER BY edittime ASC LIMIT $offset,$pagesize";
...
$content .="<table height=264 border=0 cellpadding=0 cellspacing=0 >"
         ."<tr>"
	       ...
	       ."<td align='left' valign='top'><table border=1 cellpadding=0 cellspacing=0>"
		     ."<tr>"
		     ."<td width=120 align='center' class='STYLE1'>ID</td>"
		     ."<td width=120 align='center' class='STYLE1'>编码</td>"
	       ...
	       ."<td width=120 align='center' class='STYLE1'>可脱（名称）</td>"//新增 omissible 
	       ."<td width=120 align='center' class='STYLE1'>不可脱（名称）</td>"//新增 unomissible
	       ."<td width=120 align='center' class='STYLE1'>任意名</td>"//新增 random_name 
	       ."<td width=120 align='center' class='STYLE1'>主营/类别</td>"//新增 main_work
	       ."<td width=120 align='center' class='STYLE1'>单位属性</td>"//新增 attribute
	       ."<td width=120 align='center' class='STYLE1'>分支机构</td>"//新增 branch
	       ."<td width=120 align='center' class='STYLE1'>修饰字符</td>"//新增 adjective
	       ...
	       ."<td width=120 align='center' class='STYLE1'>大厦/工业区/花园</td>"
	       ."<td width=50 align='center' class='STYLE1'>剩余地址</td>"//原为栋、层
	       ."<td width=50 align='center' class='STYLE1'>修饰地址</td>"
	       ."<td width=120 align='center'><span class='STYLE1'>企业联系人</span></td>"  
	       //."<td width=120 height=25 align='center' class='STYLE1'>行政区域</td>"   
	       ."<td width=120 height=25 align='center' class='STYLE1'>行业类别</td>" 
	       ."<td width=120 height=25 align='center' class='STYLE1'>主营</td>"
	       ."<td width=120 align='center' class='STYLE1'>原电话</td>" 
	       ."<td width=120 align='center' class='STYLE1'>新电话</td>" 
	       ."<td width=120 align='center' class='STYLE1'>企业联系人手机</td>" 
	       ."<td width=50 height=25 align='center' class='STYLE1'>传真</td>" 
	       ."<td width=120 height=25 align='center' class='STYLE1'>网址</td>" 
	       ."<td width=120 height=25 align='center' class='STYLE1'>邮箱</td>" 
	       ."<td width=120 height=25 align='center' class='STYLE1'>发行负责人</td>" 
	       ."<td width=50 height=25 align='center' class='STYLE1'>录入人</td>" 
	       ."<td width=120 height=25 align='center' class='STYLE1'>录入日期</td>" 
	      // ."<td width=120 height=25 align='center' class='STYLE1'>派送物品</td>" 	       
