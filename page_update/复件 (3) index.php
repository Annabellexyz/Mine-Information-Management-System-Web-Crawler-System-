...
//"<form name=form1 method=post action='index_update.php?lmbs={$row[id]}'"
 $content_id .= "<table align='center' width='620' border='1'>"
              ."<form name='form1' method='post' action='index_update.php?lmbs={$row[id]}'>"
              ."<tr><td width=100 align='center' class='STYLE1'>ID</td>"
              ...
              ."<tr><td width=100 align='center' class='STYLE1'>企业联系人手机</td>"
...
$query1 ="SELECT * FROM `china_szpage` {$sqlWhere} ORDER BY id ASC LIMIT $offset,$pagesize";
...
$content .="<table height=264 border=0 cellpadding=0 cellspacing=0 >"
         ."<tr>"
	       ...
	       ."<td align='left' valign='top'><table border=1 cellpadding=0 cellspacing=0>"
		     ."<tr>"
		     ."<td width=100 align='center' class='STYLE1'>ID</td>"
	       ...
	       ."<td width=100 align='center' class='STYLE1'>企业联系人手机</td>" 
